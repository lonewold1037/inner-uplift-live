...
class GenerateTitleAndExtendedRecapJob < ApplicationJob
  ...
  def generate_extended_recap(reflection)
    ...
    Your task: Continue with Acts 2-5 for EXACTLY 480-500 words to fill 4:45 of audio.
    ...
    🔥 CONTINUATION RULES:
    - Write EXACTLY 480-500 words - NO LESS THAN 480 (critical for audio timing)
